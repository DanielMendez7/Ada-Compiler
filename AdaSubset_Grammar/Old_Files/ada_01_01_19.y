...
#include "record.c"
#include "patchDataStructures.c"
 
TreeELEM stackOfTrees[25]; //Handles up to 25 Ada procedures 
...
FILE *output;      //Write to file so you can test output code with Abstract Machine Instructions
extern int lineno; 
%}
