/***************************** Moving onto case statements! 12_11_19 *********************/
                                                                  ...
                                                                  //KIND IS PROCEDURE(enum 2): a procedure so calculate static, dynamic, next base, and return address
                                                                      ...
                                                                      while (argumentParamList != NULL) {                                                                          
                                                                          ...
                                                                          if ((strcmp(parameterList->mode, "in out") == 0) || (strcmp(parameterList->mode, "out") == 0)) { 
                                                                              ...
                                                                              if (strcmp(parameterList->mode, "in out") == 0) {
                                                                                  if (formalParamWalk != 0) {
                                                                                      while (formalParamWalk != 0) {
                                                                                          fprintf(output, "%d: r%d := contents r%d, 2\n",
                                                                                                  globalRecord.pc++, globalRecord.registerNumber, procedureARBase);
                                                                                          formalParamWalk--;
                                                                                      }
                                                                                      procedureARBase = globalRecord.registerNumber++;
                                                                                  }
                                                                              
                                                                                  //Formal Parameter is a local variable
                                                                                  fprintf(output, "%d: contents b, %d := contents r%d, %d\n",
                                                                                          globalRecord.pc++, parameterList->offset, procedureARBase, argumentParamList->record->offset);
                                                                              }

                                                                              
                                                                              //CASE 3: Only do this for "out" parameters
                                                                              ...
                                                                              fprintf(output, "%d: r%d := r%d + r%d\n",
                                                                                      globalRecord.pc++, globalRecord.registerNumber, procedureARBase, saveOffSet );
...
case_statement : CASE initial  IS WHEN initial ARROW sequence_of_statements END CASE
;
