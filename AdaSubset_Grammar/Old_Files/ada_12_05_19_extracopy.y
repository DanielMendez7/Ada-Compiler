/******************** Just finished full else if statements *******************/
// There are some problems with jump number in fourthHandout.ada
...
component_list          : record_object ';' component_list // can put record into symbol table but not its individual components
                        | record_object ';'
                        ;
